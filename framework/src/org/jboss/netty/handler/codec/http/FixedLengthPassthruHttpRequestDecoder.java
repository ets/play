...
public class FixedLengthPassthruHttpRequestDecoder extends ReplayingDecoder<FixedLengthPassthruHttpRequestDecoder.State> {
     ...
     */
    public FixedLengthPassthruHttpRequestDecoder() {
        this(4096, 8192, 8192);
    }
